...
internal static partial class TopologyVisualExamples {
    ...
    private static TopologyChart BuildTopologyExplorer() {
        return TopologyChart.Create()
            ...
            .AddEdge("amer-hub-west", "amer-hub", "nam-west", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("amer-hub-east", "amer-hub", "nam-east", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("amer-hub-sa", "amer-hub", "sa-south", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("nam-west-la", "nam-west", "la-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("nam-east-ny", "nam-east", "ny-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("sa-sp", "sa-south", "sp-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("emea-hub-west", "emea-hub", "eu-west", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("emea-hub-central", "emea-hub", "eu-central", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("emea-hub-east", "emea-hub", "eu-east", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("eu-west-uk", "eu-west", "uk-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("eu-central-de", "eu-central", "de-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("eu-east-tr", "eu-east", "tr-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("apac-hub-se", "apac-hub", "se-asia", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("apac-hub-anz", "apac-hub", "anz", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("apac-hub-in", "apac-hub", "in-india", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("se-sg", "se-asia", "sg-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("anz-syd", "anz", "syd-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("in-bom", "in-india", "bom-branch", null, TopologyEdgeKind.Link, TopologyHealthStatus.Unknown, VisualLinkDirection.None, TopologyEdgeRouting.Orthogonal)
            .AddEdge("amer-emea", "amer-hub", "emea-hub", "24 ms", TopologyEdgeKind.Link, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "MPLS", "/links/amer-emea")
            .AddEdge("emea-apac", "emea-hub", "apac-hub", "82 ms", TopologyEdgeKind.Link, TopologyHealthStatus.Warning, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "MPLS", "/links/emea-apac")
            .AddEdge("apac-anz", "apac-hub", "anz", "142 ms", TopologyEdgeKind.Link, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "critical", "/links/apac-anz")
            .AddEdge("amer-bh", "ny-branch", "bh-1", "32 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "bridgehead")
            .AddEdge("bh-link", "bh-1", "bh-2", "68 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "queue 44")
            .AddEdge("bh-apac", "bh-2", "syd-branch", "142 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "failed")
    ...
    private static TopologyChart BuildReusableRegionalTopology() {
        return TopologyChart.Create()
            ...
            .AddEdge("amer-emea", "amer-hub", "emea-hub", "24 ms", TopologyEdgeKind.Link, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, "MPLS", "/links/amer-emea")
            .AddEdge("emea-apac", "emea-hub", "apac-hub", "82 ms", TopologyEdgeKind.Link, TopologyHealthStatus.Warning, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, "MPLS", "/links/emea-apac")
            .AddEdge("amer-bh", "nam-east", "bh-1", "32 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, "bridgehead")
            .AddEdge("bh-replication", "bh-1", "bh-2", "68 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, "queue 44")
            .AddEdge("bh-apac", "bh-2", "bh-3", "142 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, "failed")
            .WithNodesDisplay(TopologyNodeKind.Server, TopologyNodeDisplayMode.Card)
            .WithEdgeLineStyle("amer-bh", TopologyEdgeLineStyle.Dashed)
    ...
    private static TopologyChart BuildReplicationMeshExplorer() {
        var chart = TopologyChart.Create()
            ...
            .AddEdge("nyc-local", "nyc-dc1", "nyc-dc2", "12 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("lon-local", "lon-dc1", "lon-dc2", "14 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("fra-local", "fra-dc1", "fra-dc2", "56 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("sfo-local", "sfo-dc1", "sfo-dc2", "18 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("sin-local", "sin-dc1", "sin-dc2", "124 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Critical, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
            .AddEdge("nyc-lon", "nyc-dc1", "lon-dc1", "105 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "Q:312", tertiaryLabel: "15m / 2m")
            .AddEdge("lon-nyc", "lon-dc1", "nyc-dc1", "107 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "Q:233", tertiaryLabel: "7m ago")
            .AddEdge("lon-fra", "lon-dc2", "fra-dc1", "156 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "Q:842", tertiaryLabel: "3m ago")
            .AddEdge("fra-lon", "fra-dc1", "lon-dc2", "142 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "Q:615", tertiaryLabel: "5m ago")
            .AddEdge("fra-sin", "fra-dc2", "sin-dc1", "238 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "Q:1124", tertiaryLabel: "2m ago")
            .AddEdge("sin-fra", "sin-dc1", "fra-dc2", "198 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "Q:876", tertiaryLabel: "4m ago")
            .AddEdge("sfo-sin", "sfo-dc2", "sin-dc1", "214 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "Q:1552", tertiaryLabel: "1m ago")
            .AddEdge("sin-sfo", "sin-dc1", "sfo-dc2", "124 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "Q:910", tertiaryLabel: "3m ago")
            .AddEdge("nyc-sfo", "nyc-dc1", "sfo-dc1", "107 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "Q:233", tertiaryLabel: "7m ago")
            .AddEdge("sfo-nyc", "sfo-dc1", "nyc-dc1", "112 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "Q:276", tertiaryLabel: "9m ago")
            .AddEdge("lon-sfo", "lon-dc1", "sfo-dc1", "118 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "Q:301", tertiaryLabel: "10m ago")
            .AddEdge("sfo-lon", "sfo-dc1", "lon-dc1", "121 ms", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "Q:289", tertiaryLabel: "9m ago")
    ...
    private static TopologyChart BuildSubnetsSiteLinksMap() {
        return TopologyChart.Create()
            ...
            .AddEdge("amer-emea", "amer-hub", "emea-hub", "MPLS", TopologyEdgeKind.Link, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "$1.20 / Mbps", tertiaryLabel: "24 ms")
            .AddEdge("emea-apac", "emea-hub", "apac-hub", "MPLS", TopologyEdgeKind.Link, TopologyHealthStatus.Warning, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "$1.35 / Mbps", tertiaryLabel: "82 ms")
            .AddEdge("apac-anz", "apac-hub", "anz", "MPLS", TopologyEdgeKind.Mapping, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal, "$1.10 / Mbps", tertiaryLabel: "62 ms")
            .AddEdge("amer-bh", "na-east", "bh-1", "mapped", TopologyEdgeKind.Mapping, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal)
            .AddEdge("emea-bh", "eu-east", "bh-2", "degraded", TopologyEdgeKind.Mapping, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal)
            .AddEdge("apac-bh", "india", "bh-3", "mapped", TopologyEdgeKind.Mapping, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Orthogonal)
            .WithEdgePorts("amer-emea", TopologyEdgePort.Right, TopologyEdgePort.Left)
            .WithEdgePorts("emea-apac", TopologyEdgePort.Right, TopologyEdgePort.Left)
            .WithEdgePorts("apac-anz", TopologyEdgePort.Bottom, TopologyEdgePort.Top)
    ...
    private static TopologyChart BuildDcConnectivityMap() {
        return TopologyChart.Create()
            ...
            .AddEdge("na-dc02-na-dc01", "na-dc02", "na-dc01", "LDAP OK", TopologyEdgeKind.Connectivity, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "Kerberos OK")
            .AddEdge("na-dc03-na-dc01", "na-dc03", "na-dc01", "DNS OK", TopologyEdgeKind.Connectivity, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "RPC")
            .AddEdge("rodc-na-dc01", "na-rodc01", "na-dc01", "RODC", TopologyEdgeKind.AuthenticationPath, TopologyHealthStatus.Unknown, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "No recent bind")
            .AddEdge("na-dc01-eu-dc01", "na-dc01", "eu-dc01", "72 ms", TopologyEdgeKind.Connectivity, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "RPC")
            .AddEdge("na-dc01-ap-dc01", "na-dc01", "ap-dc01", "168 ms", TopologyEdgeKind.Connectivity, TopologyHealthStatus.Warning, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "Queue 18")
            .AddEdge("na-dc01-na-dc04", "na-dc01", "na-dc04", "LDAP fail", TopologyEdgeKind.Connectivity, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight, "DNS OK")
    ...
    private static TopologyChart BuildAdSitesHierarchy() {
        return TopologyChart.Create()
            ...
            .AddEdge("amer-emea", "amer-hub", "emea-hub", "72 ms", TopologyEdgeKind.Link, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight)
            .AddEdge("emea-apac", "emea-hub", "apac-hub", "168 ms", TopologyEdgeKind.Link, TopologyHealthStatus.Warning, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight)
    ...
    private static TopologyChart BuildReplicationHealthHub() {
        ...
        chart
            .AddEdge("cloud-ams", "cloud", "AMS-top", "warning", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Forward, TopologyEdgeRouting.Curved)
            .AddEdge("cloud-fra", "cloud", "FRA-top", "healthy", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Curved)
            .AddEdge("cloud-sin", "cloud", "SIN-left", "critical", TopologyEdgeKind.Replication, TopologyHealthStatus.Critical, VisualLinkDirection.Forward, TopologyEdgeRouting.Straight)
    ...
    private static TopologyChart BuildDirectoryHealthReplication() {
        return TopologyChart.Create()
            ...
            .AddEdge("rep-1", "dc-ktw1-01", "dc-ktw2-01", "healthy", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "1m ago")
            .AddEdge("rep-2", "dc-ktw1-02", "dc-ktw2-02", "warning", TopologyEdgeKind.Replication, TopologyHealthStatus.Warning, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "27m lag")
            .AddEdge("rep-3", "dc-ktw1-04", "dc-ktw2-03", "healthy", TopologyEdgeKind.Replication, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.Straight, "2m ago")
    ...
    private static TopologyChart BuildServiceDependencyMap() {
        return TopologyChart.Create()
            ...
            .AddEdge("dns-api", "dns", "api", "100%", TopologyEdgeKind.Dependency, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward)
            .AddEdge("ldap-api", "ldap", "api", "98.4%", TopologyEdgeKind.Dependency, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward)
            .AddEdge("krb-api", "kerberos", "api", "96.2%", TopologyEdgeKind.Dependency, TopologyHealthStatus.Warning, VisualLinkDirection.Forward)
            .AddEdge("api-queue", "api", "queue", "1,287", TopologyEdgeKind.DataFlow, TopologyHealthStatus.Warning, VisualLinkDirection.Forward)
            .AddEdge("api-sql", "api", "sql", "P95 412 ms", TopologyEdgeKind.Dependency, TopologyHealthStatus.Critical, VisualLinkDirection.Forward)
            .AddEdge("team-api", "team", "api", "owns", TopologyEdgeKind.Ownership, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.Curved);
    }
    ...
    private static void AddSiteDots(TopologyChart chart, string prefix, double x, double y, int count, TopologyHealthStatus status) {
        for (var i = 0; i < count; i++) {
            ...
            if (i > 0 && col != 0) {
                chart.AddEdge(prefix + "-mesh-" + i.ToString(CultureInfo.InvariantCulture), prefix + "-" + i.ToString(CultureInfo.InvariantCulture), prefix + "-" + (i + 1).ToString(CultureInfo.InvariantCulture), null, TopologyEdgeKind.Replication, status, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
    ...
    private static void AddReplicationFan(TopologyChart chart, string hubId, string sitePrefix, int start, int count, TopologyHealthStatus status, TopologyEdgePort sourcePort, TopologyEdgePort targetPort) {
        for (var i = start; i < start + count; i++) {
            ...
            chart.AddEdge(edgeId, hubId, sitePrefix + "-" + i.ToString(CultureInfo.InvariantCulture), null, TopologyEdgeKind.Replication, status, VisualLinkDirection.None, TopologyEdgeRouting.Straight)
