...
internal static class DenseSignalExamples {
    internal static void Write(string output, ChartPngOutputScale pngOutputScale) {
        var chart = Chart.Create()
            ...
            .WithSubtitle("50,000 source samples reduced explicitly to an 800-point report surface with source-index provenance")
            .WithXAxis("Sample")
            .WithYAxis("Latency")
            ...
            .AddDecimatedLine(
                ...
                800,
                ChartDecimationMode.LargestTriangleThreeBuckets,
