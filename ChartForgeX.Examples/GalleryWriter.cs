...
public static partial class GalleryWriter {
    ...
    private static void AppendComparisonCard(System.Text.StringBuilder sb, ComparisonAsset pair) {
        ...
        var wipeId = Slugify(name);
        sb.AppendLine("<figure class=\"wipe-figure\"><figcaption class=\"caption\"><span class=\"format\">WIPE</span><span class=\"dims\">" + EscapeHtml(FormatDimensions(svg)) + "</span></figcaption><div class=\"wipe-controls\" aria-label=\"" + EscapeHtml(name) + " wipe position\"><input class=\"wipe-25\" type=\"radio\" name=\"wipe-" + EscapeHtml(wipeId) + "\" id=\"wipe-" + EscapeHtml(wipeId) + "-25\"><label for=\"wipe-" + EscapeHtml(wipeId) + "-25\">SVG 25%</label><input class=\"wipe-50\" type=\"radio\" name=\"wipe-" + EscapeHtml(wipeId) + "\" id=\"wipe-" + EscapeHtml(wipeId) + "-50\" checked><label for=\"wipe-" + EscapeHtml(wipeId) + "-50\">Split</label><input class=\"wipe-75\" type=\"radio\" name=\"wipe-" + EscapeHtml(wipeId) + "\" id=\"wipe-" + EscapeHtml(wipeId) + "-75\"><label for=\"wipe-" + EscapeHtml(wipeId) + "-75\">SVG 75%</label><div class=\"media wipe\"" + ratioStyle + "><img src=\"" + EscapeHtml(name) + ".png\" alt=\"" + EscapeHtml(name) + " PNG wipe right\"><object data=\"" + EscapeHtml(name) + ".svg\" type=\"image/svg+xml\" aria-label=\"" + EscapeHtml(name) + " SVG wipe left\"></object></div></div></figure>");
