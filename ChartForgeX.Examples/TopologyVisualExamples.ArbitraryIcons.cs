...
internal static partial class TopologyVisualExamples {
    ...
    private static TopologyChart BuildSecureAccessArbitraryIconTopology() {
        return TopologyChart.Create()
            ...
            .AddEdge("resource-policy", "resource-devices", "resource-lock", "user aware policy distribution", TopologyEdgeKind.AuthenticationPath, TopologyHealthStatus.Healthy, VisualLinkDirection.Backward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, "over tunnels", color: "#111827")
            .AddEdge("home-policy", "home-devices", "home-lock", "policy tunnel", TopologyEdgeKind.AuthenticationPath, TopologyHealthStatus.Healthy, VisualLinkDirection.Backward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, color: "#0E7490")
            .AddEdge("resource-gateway", "resource-lock", "gateway-policy", null, TopologyEdgeKind.AuthenticationPath, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, color: "#111827")
            .AddEdge("home-gateway", "home-lock", "gateway-private", null, TopologyEdgeKind.AuthenticationPath, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, color: "#0E7490")
            .AddEdge("entra-policy", "entra", "gateway-policy", "policy", TopologyEdgeKind.AuthenticationPath, TopologyHealthStatus.Healthy, VisualLinkDirection.Bidirectional, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, color: "#0E7490")
            .AddEdge("gateway-m365", "gateway-policy", "m365", null, TopologyEdgeKind.DataFlow, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, color: "#0E7490")
            .AddEdge("gateway-internet-route", "gateway-internet", "internet", null, TopologyEdgeKind.DataFlow, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, color: "#0E7490")
            .AddEdge("gateway-private-route", "gateway-private", "datacenter", null, TopologyEdgeKind.DataFlow, TopologyHealthStatus.Healthy, VisualLinkDirection.Forward, TopologyEdgeRouting.ObstacleAvoidingOrthogonal, color: "#0E7490")
