...
public sealed class GraphSceneNeighborhoodOptions {
    ...
    /// <summary>Gets or sets the maximum number of visible nodes, including the root. Defaults to 13.</summary>
    public int MaximumNodes { get; set; } = 13;

    /// <summary>Gets or sets the maximum number of visible relationships. Defaults to 24; zero produces a node-only view.</summary>
    public int MaximumEdges { get; set; } = 24;
