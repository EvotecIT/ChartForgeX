...
- Keep PDF and Office document generation in OfficeIMO adapters over `VisualArtifact`; expand the handoff metadata only when a real Word, Excel, PowerPoint, or PDF placement contract needs it.
