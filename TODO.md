...
- Continue graph explorer hardening beyond SVG/Canvas/WebGL rendering, worker physics, live release/reheat dragging, compact large-scene documents, graph-native hierarchy navigation, deterministic static stage exports, adaptive clustering, atomic patches, and the 1k/2k/5k/10k fixtures with persisted physics state, OffscreenCanvas rendering hardening, lasso/box selection, group transforms, undo/redo, and automated cross-platform CI performance budgets.
