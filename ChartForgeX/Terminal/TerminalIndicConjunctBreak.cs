...
/// <summary>Unicode 17.0 Indic_Conjunct_Break property lookup used by deterministic terminal grapheme segmentation.</summary>
internal static class TerminalIndicConjunctBreak {
    public static bool IsConsonant(int codePoint) => Contains(ConsonantRanges, codePoint);
    ...
    private static bool Contains(int[] ranges, int codePoint) {
        ...
        while (low <= high) {
            ...
            var offset = middle * 2;
            if (codePoint < ranges[offset]) {
                high = middle - 1;
            } else if (codePoint > ranges[offset + 1]) {
                low = middle + 1;
            } else {
                return true;
            }
    ...
    // Generated from https://www.unicode.org/Public/17.0.0/ucd/DerivedCoreProperties.txt.
    private static readonly int[] ConsonantRanges = {
        ...
        0xC58, 0xC5A, 0xD15, 0xD3A, 0x1000, 0x102A,
    ...
    // Generated from https://www.unicode.org/Public/17.0.0/ucd/DerivedCoreProperties.txt.
    private static readonly int[] ExtendRanges = {
        0x300, 0x36F, 0x483, 0x487, 0x488, 0x489,
        0x591, 0x5BD, 0x5BF, 0x5BF, 0x5C1, 0x5C2,
        0x5C4, 0x5C5, 0x5C7, 0x5C7, 0x610, 0x61A,
        0x64B, 0x65F, 0x670, 0x670, 0x6D6, 0x6DC,
        ...
        0x859, 0x85B, 0x897, 0x89F, 0x8CA, 0x8E1,
        0x8E3, 0x902, 0x93A, 0x93A, 0x93C, 0x93C,
        0x941, 0x948, 0x951, 0x957, 0x962, 0x963,
        0x981, 0x981, 0x9BC, 0x9BC, 0x9BE, 0x9BE,
        0x9C1, 0x9C4, 0x9D7, 0x9D7, 0x9E2, 0x9E3,
        0x9FE, 0x9FE, 0xA01, 0xA02, 0xA3C, 0xA3C,
        0xA41, 0xA42, 0xA47, 0xA48, 0xA4B, 0xA4D,
        0xA51, 0xA51, 0xA70, 0xA71, 0xA75, 0xA75,
        0xA81, 0xA82, 0xABC, 0xABC, 0xAC1, 0xAC5,
        0xAC7, 0xAC8, 0xAE2, 0xAE3, 0xAFA, 0xAFF,
        0xB01, 0xB01, 0xB3C, 0xB3C, 0xB3E, 0xB3E,
        0xB3F, 0xB3F, 0xB41, 0xB44, 0xB55, 0xB56,
        0xB57, 0xB57, 0xB62, 0xB63, 0xB82, 0xB82,
        0xBBE, 0xBBE, 0xBC0, 0xBC0, 0xBCD, 0xBCD,
        0xBD7, 0xBD7, 0xC00, 0xC00, 0xC04, 0xC04,
        0xC3C, 0xC3C, 0xC3E, 0xC40, 0xC46, 0xC48,
        0xC4A, 0xC4C, 0xC55, 0xC56, 0xC62, 0xC63,
        0xC81, 0xC81, 0xCBC, 0xCBC, 0xCBF, 0xCBF,
        0xCC0, 0xCC0, 0xCC2, 0xCC2, 0xCC6, 0xCC6,
        0xCC7, 0xCC8, 0xCCA, 0xCCB, 0xCCC, 0xCCD,
        0xCD5, 0xCD6, 0xCE2, 0xCE3, 0xD00, 0xD01,
        0xD3B, 0xD3C, 0xD3E, 0xD3E, 0xD41, 0xD44,
        0xD57, 0xD57, 0xD62, 0xD63, 0xD81, 0xD81,
        0xDCA, 0xDCA, 0xDCF, 0xDCF, 0xDD2, 0xDD4,
        0xDD6, 0xDD6, 0xDDF, 0xDDF, 0xE31, 0xE31,
        0xE34, 0xE3A, 0xE47, 0xE4E, 0xEB1, 0xEB1,
        0xEB4, 0xEBC, 0xEC8, 0xECE, 0xF18, 0xF19,
        0xF35, 0xF35, 0xF37, 0xF37, 0xF39, 0xF39,
        0xF71, 0xF7E, 0xF80, 0xF84, 0xF86, 0xF87,
        0xF8D, 0xF97, 0xF99, 0xFBC, 0xFC6, 0xFC6,
        0x102D, 0x1030, 0x1032, 0x1037, 0x103A, 0x103A,
        ...
        0x17C9, 0x17D1, 0x17D3, 0x17D3, 0x17DD, 0x17DD,
        ...
        0x1ABF, 0x1ADD, 0x1AE0, 0x1AEB, 0x1B00, 0x1B03,
        0x1B34, 0x1B34, 0x1B35, 0x1B35, 0x1B36, 0x1B3A,
        0x1B3B, 0x1B3B, 0x1B3C, 0x1B3C, 0x1B3D, 0x1B3D,
        0x1B42, 0x1B42, 0x1B43, 0x1B43, 0x1B6B, 0x1B73,
        0x1B80, 0x1B81, 0x1BA2, 0x1BA5, 0x1BA8, 0x1BA9,
        0x1BAA, 0x1BAA, 0x1BAC, 0x1BAD, 0x1BE6, 0x1BE6,
        0x1BE8, 0x1BE9, 0x1BED, 0x1BED, 0x1BEF, 0x1BF1,
        0x1BF2, 0x1BF3, 0x1C2C, 0x1C33, 0x1C36, 0x1C37,
        0x1CD0, 0x1CD2, 0x1CD4, 0x1CE0, 0x1CE2, 0x1CE8,
        0x1CED, 0x1CED, 0x1CF4, 0x1CF4, 0x1CF8, 0x1CF9,
        0x1DC0, 0x1DFF, 0x200D, 0x200D, 0x20D0, 0x20DC,
        ...
        0xAAEC, 0xAAED, 0xABE5, 0xABE5, 0xABE8, 0xABE8,
        ...
        0x11100, 0x11102, 0x11127, 0x1112B, 0x1112D, 0x11132,
        0x11134, 0x11134, 0x11173, 0x11173, 0x11180, 0x11181,
        ...
        0x113C7, 0x113C9, 0x113CE, 0x113CE, 0x113CF, 0x113CF,
        ...
        0x116AD, 0x116AD, 0x116B0, 0x116B5, 0x116B6, 0x116B6,
        ...
        0x1193D, 0x1193D, 0x11943, 0x11943, 0x119D4, 0x119D7,
        0x119DA, 0x119DB, 0x119E0, 0x119E0, 0x11A01, 0x11A0A,
        0x11A33, 0x11A38, 0x11A3B, 0x11A3E, 0x11A51, 0x11A56,
        0x11A59, 0x11A5B, 0x11A8A, 0x11A96, 0x11A98, 0x11A98,
        ...
        0x11F40, 0x11F40, 0x11F41, 0x11F41, 0x11F5A, 0x11F5A,
    ...
    // Generated from https://www.unicode.org/Public/17.0.0/ucd/DerivedCoreProperties.txt.
    private static readonly int[] LinkerRanges = {
