...
internal static partial class SmokeTests {
    ...
    private static void VisNetworkCompatRendersHierarchicalStyledHtml() {
        ...
        Assert(html.Contains("class=\"cfx-graph-node cfx-graph-node-shadow", StringComparison.Ordinal) && html.Contains("style=\"--cfx-node-fill:#F97316;--cfx-node-stroke:#7C2D12\"", StringComparison.Ordinal), "Graph explorer SVG should apply node shadows to the complete node group while retaining mark colors and selected-node feedback.");
