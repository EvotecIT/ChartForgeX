...
internal static partial class SmokeTests {
    ...
    private static void PngRendererUsesEmphasizedReportText() {
        ...
        Assert(pngHeatmap.Contains("EstimatePngStyledTextWidth(\"100%\"", StringComparison.Ordinal) && pngHeatmap.Contains("EstimatePngStyledTextBoundsHeight(dataFontSize, dataStyle)", StringComparison.Ordinal), "PNG heatmap fitting and side-label reserves should use resolved data-label bounds.");
