...
internal static partial class SmokeTests {
    private static void GraphHierarchyContractValidatesAndRendersNavigation() {
        ...
        Assert(html.Contains("if (!currentId) return false;", StringComparison.Ordinal), "Hierarchy navigation should leave ArrowLeft available to roving focus when the graph is already at the overview.");
