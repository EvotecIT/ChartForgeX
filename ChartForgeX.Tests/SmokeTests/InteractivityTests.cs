...
internal static partial class SmokeTests {
    ...
    private static void InteractiveHtmlWrapsSvgWithoutExternalDependencies() {
        ...
        Assert(html.Contains("root.dataset.cfxBrush", StringComparison.Ordinal) && html.Contains("new CustomEvent('cfxbrush'", StringComparison.Ordinal), "Interactive HTML should publish brush selection state for host code.");
        Assert(html.Contains("new XMLSerializer().serializeToString(svg)", StringComparison.Ordinal) && html.Contains("new CustomEvent('cfxexport'", StringComparison.Ordinal), "Interactive HTML should export inline SVG without external libraries.");
