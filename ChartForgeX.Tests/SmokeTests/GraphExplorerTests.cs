...
internal static partial class SmokeTests {
    ...
    private static void GraphExplorerHtmlAdapterRendersSelfContainedScene() {
        ...
        Assert(html.Contains("edgeRenderTarget", StringComparison.Ordinal) && html.Contains("edge.target.size + 7", StringComparison.Ordinal), "Graph explorer runtime layout should keep directed SVG edge markers trimmed after physics or dragging updates.");
