...
internal static partial class SmokeTests {
    ...
    private static void GraphExplorerHtmlAdapterRendersSelfContainedScene() {
        ...
        Assert(html.Contains("distanceToQuadratic(point, edge.source, control, edgeRenderTarget(edge, control))", StringComparison.Ordinal), "Graph explorer Canvas hit testing should follow the rendered quadratic curve for curved edges.");
        ...
        Assert(HtmlGraphExplorerRenderer.BuildInteractionScript().Contains("const tooltipDetail = details.length === 1 ? details[0] : detail", StringComparison.Ordinal), "Graph explorer runtime should show the remaining selected item in the tooltip after additive deselection leaves one item selected.");
