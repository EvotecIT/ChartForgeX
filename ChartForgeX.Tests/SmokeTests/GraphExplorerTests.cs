...
internal static partial class SmokeTests {
    ...
    private static void GraphExplorerHtmlAdapterRendersSelfContainedScene() {
        ...
        Assert(html.Contains(".cfx-graph-has-overview .cfx-graph-overview", StringComparison.Ordinal) && html.Contains("display: block;", StringComparison.Ordinal), "Graph explorer CSS should show the overview only when viewport navigation is enabled.");
