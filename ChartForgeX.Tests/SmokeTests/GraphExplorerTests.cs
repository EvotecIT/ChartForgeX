...
internal static partial class SmokeTests {
    ...
    private static void GraphExplorerHtmlAdapterRendersSelfContainedScene() {
        ...
        Assert(html.Contains("distanceToQuadratic(point, rendered.source, control, edgeRenderTarget(rendered, control))", StringComparison.Ordinal), "Graph explorer Canvas hit testing should follow the rendered quadratic curve for curved and aggregate edges.");
