...
internal static partial class SmokeTests {
    ...
    private static void ExampleAppClearsGeneratedOutputBeforeWriting() {
        ...
        Assert(graphScriptParts.Length == 11 && graphScriptParts[0].EndsWith("00-core.js", StringComparison.Ordinal) && graphScriptParts[1].EndsWith("02-geometry.js", StringComparison.Ordinal) && graphScriptParts[2].EndsWith("05-viewport.js", StringComparison.Ordinal) && graphScriptParts[3].EndsWith("10-layout.js", StringComparison.Ordinal) && graphScriptParts[4].EndsWith("11-state-sync.js", StringComparison.Ordinal) && graphScriptParts[5].EndsWith("12-overview.js", StringComparison.Ordinal) && graphScriptParts[6].EndsWith("15-hit-testing.js", StringComparison.Ordinal) && graphScriptParts[7].EndsWith("18-structural-physics.js", StringComparison.Ordinal) && graphScriptParts[8].EndsWith("20-physics.js", StringComparison.Ordinal) && graphScriptParts[9].EndsWith("25-layout-quality.js", StringComparison.Ordinal) && graphScriptParts[10].EndsWith("30-bindings.js", StringComparison.Ordinal), "Graph explorer runtime should be assembled from ordered script fragments.");
