...
internal static partial class SmokeTests {
    ...
    private static void ExampleAppClearsGeneratedOutputBeforeWriting() {
        ...
        Assert(graphScriptParts.Length == 8 && graphScriptParts[0].EndsWith("00-core.js", StringComparison.Ordinal) && graphScriptParts[1].EndsWith("05-viewport.js", StringComparison.Ordinal) && graphScriptParts[3].EndsWith("15-hit-testing.js", StringComparison.Ordinal) && graphScriptParts[4].EndsWith("18-structural-physics.js", StringComparison.Ordinal) && graphScriptParts[6].EndsWith("25-layout-quality.js", StringComparison.Ordinal) && graphScriptParts[7].EndsWith("30-bindings.js", StringComparison.Ordinal), "Graph explorer runtime should be assembled from ordered script fragments.");
