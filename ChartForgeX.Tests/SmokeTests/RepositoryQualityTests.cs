...
internal static partial class SmokeTests {
    ...
    private static void ExampleAppClearsGeneratedOutputBeforeWriting() {
        ...
        var expectedGraphScriptParts = new[] { "00-core.js", "01-document.js", "02-geometry.js", "03-canvas-details.js", "03-canvas-nodes.js", "04-webgl.js", "05-viewport.js", "06-theme.js", "09-edge-bundles.js", "09-performance.js", "10-layout.js", "11-state-sync.js", "12-overview.js", "13-hierarchy.js", "14-state-history.js", "15-hit-testing.js", "17-physics-profile.js", "18-structural-physics.js", "19-physics-telemetry.js", "20-physics.js", "21-physics-runtime.js", "25-layout-quality.js", "26-box-selection.js", "27-pointer-interactions.js", "28-svg-export.js", "29-selection.js", "30-bindings.js", "31-physics-configurator.js", "32-manipulation.js", "39-patch-validation.js", "40-api.js" };
        Assert(graphScriptParts.Length == expectedGraphScriptParts.Length && graphScriptParts.Select(Path.GetFileName).Select(name => name!.Substring("graph-explorer.".Length)).SequenceEqual(expectedGraphScriptParts), "Graph explorer runtime should be assembled from ordered responsibility-based script fragments.");
        ...
        Assert(graphAssets.Contains("StyleResourceNames", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.chrome.css", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.editor.css", StringComparison.Ordinal) && graphAssets.Contains("ScriptResourceNames", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.02-geometry.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.03-canvas-nodes.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.06-theme.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.09-edge-bundles.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.09-performance.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.11-state-sync.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.12-overview.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.14-state-history.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.15-hit-testing.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.17-physics-profile.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.18-structural-physics.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.19-physics-telemetry.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.20-physics.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.21-physics-runtime.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.25-layout-quality.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.26-box-selection.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.27-pointer-interactions.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.31-physics-configurator.js", StringComparison.Ordinal) && graphAssets.Contains("graph-explorer.32-manipulation.js", StringComparison.Ordinal), "Graph explorer asset loader should concatenate the native chrome and editor stylesheets and ordered script fragments into one inline runtime.");
